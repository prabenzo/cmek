...
- **Slow KMS.** azure's latency rises to p50 400 ms, p99 3 s against a 500 ms timeout. azure cells flicker yellow, cold ones see slow ingest and a few 503s, in-flight calls to azure pin at the bulkhead, and the healthy p99 line stays flat.
